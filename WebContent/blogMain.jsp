		  ...
		  -->
			...
			<div class="collapse navbar-collapse" id="navbar-collapse2">
				<ul class="nav navbar-nav navbar-left">
					<li class="active"><a href="blogMain.jsp"><span
		...
		<div class="row">
			<div class="col-md-4 col-sm-6">
				...
				<div class="well">
					<form class="form-horizontal" role="form">
						...
						<ul class="list-inline">
							<li><a href="#"><i
									class="glyphicon glyphicon-align-left"></i></a></li>
							<li><a href="#"><i
									class="glyphicon glyphicon-align-center"></i></a></li>
							<li><a href="#"><i
									class="glyphicon glyphicon-align-right"></i></a></li>
						</ul>
					</form>
				</div>
				...
				<div class="panel panel-default">
					...
					<div class="panel-body">
						...
						There a load of new free Bootstrap 3 ready templates at Bootply.
						All of these templates are free and don't require extensive
			...
			<div class="col-md-4 col-sm-6">
				...
				<div class="panel panel-default">
					...
					<div class="panel-body">
						<div class="list-group">
							<a href="http://bootply.com/tagged/bootstrap-3"
								class="list-group-item active">Bootstrap 3</a> <a
								href="http://bootply.com/tagged/snippets"
								class="list-group-item">Snippets</a> <a
								href="http://bootply.com/tagged/example" class="list-group-item">Examples</a>
						</div>
					</div>
				</div>
					...
					<form class="form col-md-12 center-block"
						...
						<div class="form-group">
							<input type="email" name="email" id="loginemail"
								onkeyup="loginEmailCheck()" class="form-control input-lg"
								placeholder="Email"> <span id="loginemailcheckLayer"></span>
						</div>
						<div class="form-group">

							<input type="password" name="password" id="loginpassword"
								onkeyup="loginPassCheck()" class="form-control input-lg"
								placeholder="Password"> <span id="loginpasscheckLayer"></span>
