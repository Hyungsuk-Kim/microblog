...
<div class="navbar navbar-default" id="subnav">
    <div class="col-md-12">
        ...
        <ul class="nav navbar-nav navbar-left">
        	<li><a href="#"><span class="glyphicon glyphicon-globe"></span> 최신 글</a></li>
        	<li><a href="#"><span class="glyphicon glyphicon-picture"></span> 사진</a></li>
        	<li><a href="#"><span class="glyphicon glyphicon-font"></span> 텍스트</a></li>
        	<li><a href="#"><span class="glyphicon glyphicon-film"></span> 비디오</a></li>
        	<li><a href="#"><span class="glyphicon glyphicon-music"></span> 오디오</a></li>
        	<li><a href="#"><span class="glyphicon glyphicon-question-sign"></span> 질문</a></li>
        </ul>
          <ul class="nav navbar-nav navbar-right">
             <li>
